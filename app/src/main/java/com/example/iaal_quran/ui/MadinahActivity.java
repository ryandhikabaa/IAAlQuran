...
public class MadinahActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_madinah);

        rvSurah = findViewById(R.id.recyclerView);
        swipeLayout = findViewById(R.id.swipe_container);

        //Set up Realm
        Realm.init(MadinahActivity.this);
        ...
        AndroidNetworking.get(Constants.BASE_URL)
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onError(ANError anError) {
                        ...
                        Toast.makeText(MadinahActivity.this, Constants.EROR_DATAREALM_NULL, Toast.LENGTH_SHORT).show();
                        buildDialogrealnull(MadinahActivity.this).show();
                    }
                });
